    ...
    public class PrimitiveParser : IPrimitiveParser
    {
        ...
        public IParseResult<CharacterRange> TryParseCharacterRange(IStringStream stream, string rangeSeparator = null)
        {
            ...
            if (!startCharacterResult.IsSuccess)
                return new FailureParseResult<CharacterRange>(initialPosition, ParserMessages.CharacterRangeExpected);
            ...
            if (popCalls >= stream.Count || !stream.LookAhead(popCalls).Equals(rangeSeparator))
                return new FailureParseResult<CharacterRange>(initialPosition + popCalls,
                    ParserMessages.CharacterRangeExpected);
        ...
        public IParseResult<int> TryParseInteger(IStringStream stream)
        {
            ...
            return result.IsSuccess && result.Value.Item1 != null
                ...
                : new FailureParseResult<int>(initialPosition, result.Message);
        }
            ...
            ParseIntervalSettings settings = null)
        {
            ...
            if (popCalls >= stream.Count || !stream.LookAhead(popCalls).Equals(settings.OpenSymbol))
                return new FailureParseResult<IntegerInterval>(initialPosition,
                    ParserMessages.IntegerIntervalExpected);
            ...
            if (!lowerBound.IsSuccess)
                return new FailureParseResult<IntegerInterval>(initialPosition, ParserMessages.IntegerIntervalExpected);                
            ...
            if (!IsNextCharacterSymbol(settings.Separator, stream, popCalls))
                return new FailureParseResult<IntegerInterval>(initialPosition + popCalls, ParserMessages.IntegerIntervalSeparatorExpected);
        ...
        public IParseResult<string> TryParseCharacter(IStringStream stream)
        {
            ...
            return result.IsSuccess
                ...
                : new FailureParseResult<string>(initialPosition, result.Message);
        }
            ...
            bool executePop)
        {
            ...
            if (popCalls >= stream.Count ||
                ...
                !_alphabet.IsValid(stream.LookAhead(popCalls)))
                return new FailureParseResult<Tuple<string, int>>(stream.CurrentPosition, ParserMessages.SingleCharacterExpected);
            ...
            bool executePop)
        {
            ...
            if (popCalls >= stream.Count)
                return new FailureParseResult<Tuple<int?, int>>(stream.CurrentPosition, ParserMessages.UnexpectedEndOfStream);
            ...
            if (popCalls >= stream.Count && numberString.Equals("-"))
                return new FailureParseResult<Tuple<int?, int>>(stream.CurrentPosition, ParserMessages.IntegerExpected);
            ...
            if (string.IsNullOrEmpty(numberString))
                return new FailureParseResult<Tuple<int?, int>>(initialPosition, ParserMessages.IntegerExpected);
